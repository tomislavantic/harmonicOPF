...
def impedance_matrix(network, har_order):
    ...
    # z_abc_unsrt = {}
        ...
        for i in range(0, len(r_abc)):
            ...
            r_abc_unsrt_h[ft_nodes_unsrt[i]] = r_abc[ft_nodes_srt[i]]
            x_abc_unsrt_h[ft_nodes_unsrt[i]] = h*x_abc[ft_nodes_srt[i]]
        
        r_abc_unsrt[h] = r_abc_unsrt_h
        x_abc_unsrt[h] = x_abc_unsrt_h
        
    return r_abc_unsrt, x_abc_unsrt
